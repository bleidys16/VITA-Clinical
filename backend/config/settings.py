...
# 2. Leer el archivo .env apuntando a la raíz del proyecto (un nivel arriba de backend)
environ.Env.read_env(os.path.join(BASE_DIR.parent, '.env'))

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.2/howto/deployment/checklist/

# 3. Reemplazar valores base por los del .env
...
# 4. Configurar PostgreSQL de manera explícita
DATABASES = {
    'default': {
...
# 1. Configurar DRF para usar JWT de forma global
REST_FRAMEWORK = {
...
# 2. Personalización del tiempo de vida del Token
SIMPLE_JWT = {
